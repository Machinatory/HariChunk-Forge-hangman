package com.hari.harichunk.threading.worldgen.common.debug;
...
public class StacktraceRecorder {
    ...
    private static final boolean doRecord = Config.reduceLockRadius && Boolean.getBoolean("com.hari.harichunk.common.threading.worldgen.debug.DebugReducedLockRadius");
    private static final int recordFrequency = Mth.clamp(Integer.getInteger("com.hari.harichunk.common.threading.worldgen.debug.DebugReducedLockRadiusFrequency", 4), 1, 16);
