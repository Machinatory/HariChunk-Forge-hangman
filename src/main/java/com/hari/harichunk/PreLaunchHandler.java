...
@Mod.EventBusSubscriber(modid = "harichunk", bus = Mod.EventBusSubscriber.Bus.MOD)
public class PreLaunchHandler {

    @SubscribeEvent
    public static void onCommonSetup(FMLCommonSetupEvent event) {
        if (Boolean.getBoolean("com.hari.harichunk.mixin.doAudit")) {
            Logger auditLogger = LoggerFactory.getLogger("HariChunk Mixin Audit");
            try {
