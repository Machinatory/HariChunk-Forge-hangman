package com.hari.harichunk.base.common.config;

import com.electronwill.nightconfig.core.CommentedConfig;
import com.electronwill.nightconfig.core.file.CommentedFileConfig;
import com.hari.harichunk.base.common.util.BooleanUtils;
...
public class ConfigSystem {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger("HariChunk Config System");

    private static final long CURRENT_CONFIG_VERSION = 3;

    private static final Supplier<CommentedFileConfig> configSupplier =
            () -> CommentedFileConfig.builder(FMLPaths.CONFIGDIR.get().resolve("harichunk.toml"))
    ...
    public static class ConfigAccessor {
        ...
        private static final String propertyPrefix = "harichunk.base.config.override.";
        ...
        public ConfigAccessor incompatibleMod(String modId, String predicate) {
            ...
            try {
                ...
                if (versionRange.containsVersion(version)) {
                    String reason = String.format("Incompatible with %s@%s (%s) (defined in harichunk)", modId, version.toString(), predicate);
        ...
        private void findModDefinedIncompatibility() {
            for (IModInfo modInfo : ModUtil.getModInfoList()) {
                Object incompatibilitiesValue = modInfo.getModProperties().get("harichunk:incompatibleConfig");
        ...
        private void disableConfigWithReason(String reason) {
            ...
            if (!Boolean.getBoolean("com.hari.harichunk.base.config.ignoreIncompatibility")) {
