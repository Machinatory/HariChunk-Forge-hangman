package com.hari.harichunk.rewrites.chunkio.common;

import com.ibm.asyncutil.util.Either;
import com.hari.harichunk.base.common.GlobalExecutors;
import com.hari.harichunk.base.common.structs.RawByteArrayOutputStream;
import com.hari.harichunk.base.common.util.SneakyThrow;
import com.hari.harichunk.base.mixin.access.IRegionBasedStorage;
import com.hari.harichunk.base.mixin.access.IRegionFile;
import com.hari.harichunk.opts.chunkio.common.ConfigConstants;
...
public class HariChunkStorageThread extends Thread {

    private static final Logger LOGGER = LoggerFactory.getLogger("HariChunk Storage");
    ...
    public HariChunkStorageThread(Path directory, boolean dsync, String name) {
        this.storage = new RegionFileStorage(directory, dsync);
        this.setName("HariChunk Storage #%d".formatted(SERIAL.incrementAndGet()));
        this.setDaemon(true);
