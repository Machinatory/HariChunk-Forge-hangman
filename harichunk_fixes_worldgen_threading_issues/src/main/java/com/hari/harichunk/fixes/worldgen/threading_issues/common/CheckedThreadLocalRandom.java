...
import com.hari.harichunk.fixes.worldgen.threading_issues.common.debug.SMAPSourceDebugExtension;
...
public class CheckedThreadLocalRandom extends SingleThreadedRandomSource {
    ...
    private void handleNotOwner() {
        ...
        builder.append("This is usually NOT a bug in HariChunk, but a bug in another mod or in vanilla code. \n");
        ...
        builder.append("    - if no other mods are involved, report this to HariChunk \n");
        ...
        if (Config.enforceSafeWorldRandomAccess) {
            throw new RuntimeException(String.format("%s \n (You may make this a fatal warning instead of a hard crash with fixes.enforceSafeWorldRandomAccess setting in harichunk.toml)", s), exception) {
                @Override
