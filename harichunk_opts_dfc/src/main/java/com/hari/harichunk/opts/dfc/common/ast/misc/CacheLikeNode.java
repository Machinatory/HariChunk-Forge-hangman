...
import com.hari.harichunk.opts.dfc.common.gen.IMultiMethod;
import com.hari.harichunk.opts.dfc.common.gen.ISingleMethod;
import com.hari.harichunk.opts.dfc.common.gen.SubCompiledDensityFunction;
...
public class CacheLikeNode implements AstNode {
    ...
    public void evalMulti(double[] res, int[] x, int[] y, int[] z, EvalType type) {
        ...
        boolean cached = this.cacheLike.harichunk$getCached(res, x, y, z, type);
        if (!cached) {
            this.delegate.evalMulti(res, x, y, z, type);
            this.cacheLike.harichunk$cache(res, x, y, z, type);
        }
    }
    ...
    public void doBytecodeGenSingle(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        ...
        m.invokeinterface(Type.getInternalName(IFastCacheLike.class), "harichunk$getCached", Type.getMethodDescriptor(Type.DOUBLE_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.getType(EvalType.class)));
        m.dup2();
        ...
        m.invokeinterface(Type.getInternalName(IFastCacheLike.class), "harichunk$cache", Type.getMethodDescriptor(Type.VOID_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.INT_TYPE, Type.getType(EvalType.class), Type.DOUBLE_TYPE));
    ...
    public void doBytecodeGenMulti(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        ...
        m.invokeinterface(Type.getInternalName(IFastCacheLike.class), "harichunk$getCached", Type.getMethodDescriptor(Type.BOOLEAN_TYPE, Type.getType(double[].class), Type.getType(int[].class), Type.getType(int[].class), Type.getType(int[].class), Type.getType(EvalType.class)));
        m.ifeq(cacheMiss);
        m.areturn(Type.VOID_TYPE);
        ...
        m.load(4, InstructionAdapter.OBJECT_TYPE);
        m.load(5, InstructionAdapter.OBJECT_TYPE);
        m.invokeinterface(Type.getInternalName(IFastCacheLike.class), "harichunk$cache", Type.getMethodDescriptor(Type.VOID_TYPE, Type.getType(double[].class), Type.getType(int[].class), Type.getType(int[].class), Type.getType(int[].class), Type.getType(EvalType.class)));
        m.areturn(Type.VOID_TYPE);
    }
