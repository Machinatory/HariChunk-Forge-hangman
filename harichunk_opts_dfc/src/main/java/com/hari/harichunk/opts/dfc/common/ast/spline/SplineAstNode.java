package com.hari.harichunk.opts.dfc.common.ast.spline;
...
import com.hari.harichunk.opts.dfc.common.ast.McToAst;
...
public class SplineAstNode implements AstNode {
    ...
    public double evalSingle(int x, int y, int z, EvalType type) {
        return spline.apply(new DensityFunctions.Spline.Point(new FunctionContextVanillaInterface(x, y, z, type)));
    }
    ...
    private static ValuesMethodDef doBytecodeGenSpline(BytecodeGen.Context context, CubicSpline<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> spline) {
        ...
        if (spline instanceof CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> impl) {
            ValuesMethodDef[] valuesMethods = new ValuesMethodDef[impl.values().size()];
            for (int idx = 0; idx < impl.values().size(); idx++) {
                valuesMethods[idx] = doBytecodeGenSpline(context, impl.values().get(idx));
            }
            ...
            if (valuesMethods.length == 1) {
                ...
                m.iconst(0);
                m.invokestatic(
                        Type.getInternalName(SplineAstNode.class),
                        "assertUnreachable",
    ...
    private static boolean deepEquals(CubicSpline<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a,
        ...
        if (a instanceof CubicSpline.Constant && b instanceof CubicSpline.Constant) {
            CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a1 = (CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) a;
            CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> b1 = (CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) b;
            return a1.value() == b1.value();
        } else if (a instanceof CubicSpline.Multipoint && b instanceof CubicSpline.Multipoint) {
            CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a1 = (CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) a;
            CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> b1 = (CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) b;
    ...
    private static int deepHashcode(CubicSpline<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a) {
        if (a instanceof CubicSpline.Constant) {
            CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a1 = (CubicSpline.Constant<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) a;
            return Float.hashCode(a1.value());
        } else if (a instanceof CubicSpline.Multipoint) {
            CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate> a1 = (CubicSpline.Multipoint<DensityFunctions.Spline.Point, DensityFunctions.Spline.Coordinate>) a;
            int result = 1;
    ...
    // Used by generated bytecode for unreachable assertions
    @SuppressWarnings("unused")
    public static void assertUnreachable(boolean condition) {
        if (!condition) {
            throw new AssertionError("Unreachable code in generated spline bytecode");
        }
    }
}
