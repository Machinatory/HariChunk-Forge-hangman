...
public class DFTWeirdScaledSamplerNode implements AstNode {
    ...
    public DFTWeirdScaledSamplerNode(AstNode input, DensityFunction.NoiseHolder noiseHolder, DensityFunctions.WeirdScaledSampler.RarityValueMapper mapper) {
    ...
    public double evalSingle(int x, int y, int z, EvalType type) {
        ...
        double d = ((ToDoubleFunction<Double>) (Object) this.mapper).applyAsDouble(v);
        return d * Math.abs(InvocationShim.invokeNoiseHolderSample(this.noiseHolder, (double) x / d, (double) y / d, (double) z / d));
    }
    ...
    public void evalMulti(double[] res, int[] x, int[] y, int[] z, EvalType type) {
        ...
        for (int i = 0; i < res.length; i++) {
            double d = ((ToDoubleFunction<Double>) (Object) this.mapper).applyAsDouble(res[i]);
            res[i] = d * Math.abs(InvocationShim.invokeNoiseHolderSample(this.noiseHolder, (double) x[i] / d, (double) y[i] / d, (double) z[i] / d));
        }
    }
    ...
    public AstNode transform(AstTransformer transformer) {
        ...
        if (input == this.input) {
            ...
            return transformer.transform(new DFTWeirdScaledSamplerNode(input, this.noiseHolder, this.mapper));
        }
    }
    ...
    public void doBytecodeGenSingle(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        ...
        String mapperField = context.newField(ToDoubleFunction.class, (ToDoubleFunction<Double>) (Object) this.mapper);
        ...
        // scale = InvocationShim.invokeToDoubleFunctionApply(mapper, inputValue)
        m.load(0, InstructionAdapter.OBJECT_TYPE);
        m.getfield(context.className, mapperField, Type.getDescriptor(ToDoubleFunction.class));
        m.load(inputValue, Type.DOUBLE_TYPE);
        m.invokestatic(
                Type.getInternalName(InvocationShim.class),
                "invokeToDoubleFunctionApply",
                Type.getMethodDescriptor(Type.DOUBLE_TYPE, Type.getType(ToDoubleFunction.class), Type.DOUBLE_TYPE),
                false
        );
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(input, that.input) && Objects.equals(noiseHolder, that.noiseHolder) && mapper == that.mapper;
    }
