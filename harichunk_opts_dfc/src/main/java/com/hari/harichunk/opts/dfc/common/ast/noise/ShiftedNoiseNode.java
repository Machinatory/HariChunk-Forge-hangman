...
public class ShiftedNoiseNode implements AstNode {
    ...
    public ShiftedNoiseNode(AstNode shiftX, AstNode shiftY, AstNode shiftZ, double xzScale, double yScale, DensityFunction.NoiseHolder noiseHolder) {
    ...
    public double evalSingle(int x, int y, int z, EvalType type) {
        ...
        return InvocationShim.invokeNoiseHolderSample(this.noiseHolder, d, e, f);
    }
    ...
    public void evalMulti(double[] res, int[] x, int[] y, int[] z, EvalType type) {
        ...
        for (int i = 0; i < res.length; i++) {
            res[i] = InvocationShim.invokeNoiseHolderSample(this.noiseHolder,
    ...
    public AstNode transform(AstTransformer transformer) {
        ...
        if (shiftX == this.shiftX && shiftY == this.shiftY && shiftZ == this.shiftZ) {
            ...
            return transformer.transform(new ShiftedNoiseNode(shiftX, shiftY, shiftZ, xzScale, yScale, noiseHolder));
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(xzScale, that.xzScale) == 0 && Double.compare(yScale, that.yScale) == 0 && Objects.equals(shiftX, that.shiftX) && Objects.equals(shiftY, that.shiftY) && Objects.equals(shiftZ, that.shiftZ) && Objects.equals(noiseHolder, that.noiseHolder);
    }
