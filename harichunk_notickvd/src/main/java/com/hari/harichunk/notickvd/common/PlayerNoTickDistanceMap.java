...
public class PlayerNoTickDistanceMap extends ChunkTracker {
    ...
    public static final TicketType<ChunkPos> TICKET_TYPE = TicketType.create("harichunk_no_tick_vd", Comparator.comparingLong(ChunkPos::toLong));
    ...
    protected int getLevelFromSource(long chunkPos) {
        final ObjectSet<ServerPlayer> players = ((com.hari.harichunk.base.mixin.access.IChunkTicketManager) chunkTicketManager).getPlayersByChunkPos().get(chunkPos);
